;
; Port of ET-3400 Monitor to my Single Board Computer
...
;;      KEYBOARD LOCATIONS
        ...
        COL1  EQU $8003              ; RIGHTMOST COLUMN
        COL2  EQU $8005
        COL3  EQU $8006              ; LEFTMOST COLUMN
...
;;      DISPLAY ADDRESSES
        ...
        DG6ADD EQU $816F             ; LEFTMOST DIGIT
        DG5ADD EQU $815F
        DG4ADD EQU $814F
        DG3ADD EQU $813F
        DG2ADD EQU $812F
        DG1ADD EQU $811F             ; RIGHTMOST DIGIT
